...
2. Calendly link in `_investor/pitch.html` § 11 CTA — placeholder, needs real URL inserted
3. All `[X]` placeholders in pitch.html — traction metrics, TAM/SAM/SOM, fund allocation % still need real numbers

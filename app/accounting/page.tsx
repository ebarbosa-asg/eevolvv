...
const GHOST_WORK_ITEMS = [
  {
    ...
    pain: 'Emailing clients individually to request statements, receipts, and returns — weeks before deadline',
    win: 'Automated document request sequences with reminders and upload portals — collection time drops 60–70%',
    hrs: '5–8 hrs/wk',
  },
  {
    code: 'G-02',
    label: 'Data Entry & Reconciliation',
    pain: 'Manually entering transactions, matching invoices, reconciling accounts across clients',
    win: 'Automated reconciliation workflows with exception flagging — 80% of manual entry eliminated',
    hrs: '4–6 hrs/wk',
  },
  {
    code: 'G-03',
    label: 'Billing & AR Follow-Up',
    pain: 'Sending invoices manually and following up by phone when payment is late',
    win: 'Automated billing runs + 7/21/45-day AR sequences — collections improve 20–30%',
    hrs: '2–4 hrs/wk',
  },
  {
    code: 'G-04',
    label: 'Deadline Tracking',
    pain: 'Manually tracking tax deadlines, extension dates, and filing requirements per client',
    win: 'Automated deadline calendar with client-specific reminders and team task triggers',
    hrs: '2–3 hrs/wk',
  },
  {
    code: 'G-05',
    label: 'Client Onboarding',
    pain: 'Emailing new clients a list of what you need, then chasing them for weeks',
    win: 'Automated onboarding sequence with document checklist, portal access, and follow-up',
    hrs: '2–4 hrs/wk',
  },
  {
    code: 'G-06',
    label: 'Report Delivery',
    pain: 'Compiling monthly financials and emailing them to each client manually',
    win: 'Automated financial report generation and scheduled delivery by client — done before they ask',
    hrs: '2–3 hrs/wk',
  },
]

const STUDIO_TYPES = [
  { id: 'A-01', name: 'CPA Firms', note: 'Tax prep automation, client portals, deadline tracking' },
  { id: 'A-02', name: 'Bookkeeping Services', note: 'Transaction categorization, reconciliation, monthly reporting' },
    ...
    <main style={{ background: 'var(--paper)' }}>
      ...
      <section style={{ borderBottom: '1px solid var(--ink)', padding: '80px 32px 72px' }}>
        <div className="site-rail mx-auto">
          ...
          <h1 style={{
            ...
            Your accounting firm is running on<br />
            <span style={{ color: 'var(--accent)' }}>ghost work.</span>
          </h1>
          <p style={{ fontSize: 18, lineHeight: 1.6, opacity: 0.65, maxWidth: 560, marginBottom: 36 }}>
            Document chasing, manual data entry, late billing reminders, missed deadlines — accounting firms lose 15–25 hours every week to admin that should be automated. We find it, name it, and build the fix.
          </p>
      ...
      <section style={{ padding: '80px 32px', borderBottom: '1px solid var(--ink)' }}>
        <div className="site-rail mx-auto">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 64px', marginBottom: 16, alignItems: 'end' }}>
            <div>
              ...
              <h2 style={{ fontSize: 'clamp(26px, 4vw, 42px)', fontWeight: 700, letterSpacing: '-0.025em', lineHeight: 1.1, margin: 0 }}>
                Ghost work hiding in every accounting firm.
              </h2>
            </div>
            <div style={{ paddingBottom: 4 }}>
              <p style={{ fontSize: 15, lineHeight: 1.65, opacity: 0.6, margin: 0 }}>
                These aren&apos;t inefficiencies you can hustle through.
                They&apos;re structural drains that compound every quarter — losing you time,
                revenue, and the peace of mind you should have before every deadline.
              </p>
            </div>
          </div>
          ...
          <div className="mono" style={{ marginTop: 16, fontSize: 11, opacity: 0.4, letterSpacing: '0.08em' }}>
            Total: 17–28 hours per week recovered across a typical accounting firm.
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '72px 32px', background: 'var(--ink)', color: 'var(--paper)', borderBottom: '1px solid rgba(244,241,234,0.1)' }}>
        <div className="site-rail mx-auto">
          ...
          <h2 style={{ fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.1, marginBottom: 40, maxWidth: 600 }}>
            Every accounting model. One AI engine.
          </h2>
      ...
      <section style={{ padding: '48px 32px', borderBottom: '1px solid var(--ink)', background: 'rgba(20,20,19,0.03)' }}>
        <div className="site-rail mx-auto" style={{ display: 'flex', alignItems: 'center', gap: 32, flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', alignItems: 'center' }}>
            {['QuickBooks', 'Xero', 'Karbon', 'TaxDome', 'Practice Ignition', 'Canopy', 'Liscio', 'Gusto', 'Stripe'].map(tool => (
      ...
      <section style={{ padding: '80px 32px', borderBottom: '1px solid var(--ink)' }}>
        <div className="site-rail mx-auto">
          ...
          {/* TODO: replace with real accounting firm client testimonials */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, border: '1px solid var(--ink)' }} className="fitness-testimonial-grid">
            {[
              {
                stat: '20 hrs/wk recovered',
                quote: 'Document collection used to be my most painful month every quarter. The automated request sequences cut it from three weeks of chasing to four days. It\'s transformative.',
                name: 'Marcus T.',
                biz: 'CPA Firm — Austin, TX',
              },
              {
                stat: '+26% collections',
                quote: 'We had $85K in outstanding AR when we started. The automated billing sequences cleared 60% of it in 45 days without a single phone call.',
                name: 'Priya S.',
                biz: 'Bookkeeping Service — Chicago, IL',
              },
              {
                stat: 'zero missed deadlines',
                quote: 'We had 3 extension penalties in the last two years. Since automating our deadline tracking, we haven\'t missed a single one. The system knows before we do.',
                name: 'Jordan R.',
                biz: 'Tax Preparation Firm — Miami, FL',
              },
        ...
        <div className="site-rail mx-auto">
          <div style={{ maxWidth: 640, marginBottom: 48 }}>
            ...
            <p style={{ fontSize: 16, opacity: 0.55, lineHeight: 1.6, margin: 0 }}>
              ...
              service model, tools, and client volume.
            </p>
          </div>
          ...
          <div style={{
            ...
            <ChatEngine defaultTier="core" defaultIndustry="Accounting / Finance" />
          </div>

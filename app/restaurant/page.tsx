...
export default function RestaurantPage() {
  return (
    ...
    <script
          ...
          dangerouslySetInnerHTML={{__html: JSON.stringify(serviceSchema({name: "AI Automation for Restaurants", description: "Restaurants reduce no-shows and automate reservation follow-ups, takeout orders, and review management.", providerName: "eevolvv, Inc.", areaServed: "Dallas"}))}}
        />
    </main>
  )
}

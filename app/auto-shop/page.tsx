...
const GHOST_WORK_ITEMS = [
  {
    ...
    pain: 'A bay sitting empty for 2 hours because a customer forgot to show — no reminder went out',
    win: 'Automated 48-hr and 2-hr reminder sequence cuts no-shows by 40–60%',
    hrs: '2–3 hrs/wk',
  },
  {
    code: 'G-02',
    label: 'Declined Service Follow-Up',
    pain: 'Customer declines a repair today — you have no system to follow up in 30 days when they\'ve thought it over',
    win: 'Automated declined service campaign: follow-up at 30, 60, and 90 days closes 25–40% of declined work',
    hrs: '2–4 hrs/wk',
  },
  {
    code: 'G-03',
    label: 'Service Completion Notification',
    pain: 'Customer calls to ask if their car is ready — they have no visibility into progress',
    win: 'Automated inspection-complete and pickup-ready notifications via text — inbound calls drop 50%',
    hrs: '1–2 hrs/wk',
  },
  {
    code: 'G-04',
    label: 'Seasonal Campaigns',
    pain: 'Missing the spring tire swap and winter prep revenue because no campaign went out',
    win: 'Automated seasonal service campaigns timed to local weather patterns and vehicle service history',
    hrs: '2–3 hrs/wk',
  },
  {
    code: 'G-05',
    label: 'Review Collection',
    pain: 'Great work, almost no Google reviews because nobody remembers to ask',
    win: 'Automated post-pickup review request at the right moment — 25–35% more reviews generated',
    hrs: '1–2 hrs/wk',
  },
  {
    code: 'G-06',
    label: 'Maintenance Reminders',
    pain: 'Customers coming back only when something breaks, not for preventive service',
    win: 'Automated vehicle maintenance reminders based on mileage and service history intervals',
    hrs: '1–2 hrs/wk',
  },
]
    ...
    <main style={{ background: 'var(--paper)' }}>
      ...
      <section style={{ borderBottom: '1px solid var(--ink)', padding: '80px 32px 72px' }}>
        <div className="site-rail mx-auto">
          ...
          <h1 style={{
            ...
            Your auto shop is running on<br />
            <span style={{ color: 'var(--accent)' }}>ghost work.</span>
          </h1>
          <p style={{ fontSize: 18, lineHeight: 1.6, opacity: 0.65, maxWidth: 560, marginBottom: 36 }}>
            Appointment no-shows, declined service follow-up, manual review chasing, slow estimate response — auto shops lose 10–20 hours every week to tasks that should be automated. We find them, name them, and build the fix.
          </p>
      ...
      <section style={{ padding: '80px 32px', borderBottom: '1px solid var(--ink)' }}>
        <div className="site-rail mx-auto">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 64px', marginBottom: 16, alignItems: 'end' }}>
            <div>
              ...
              <h2 style={{ fontSize: 'clamp(26px, 4vw, 42px)', fontWeight: 700, letterSpacing: '-0.025em', lineHeight: 1.1, margin: 0 }}>
                Ghost work hiding in every auto shop.
              </h2>
            </div>
            <div style={{ paddingBottom: 4 }}>
              <p style={{ fontSize: 15, lineHeight: 1.65, opacity: 0.6, margin: 0 }}>
                These aren&apos;t inefficiencies you can hustle through.
                They&apos;re structural drains that compound every month — losing you bays,
                revenue, and the hours you should be spending under the hood.
              </p>
            </div>
          </div>
          ...
          <div className="mono" style={{ marginTop: 16, fontSize: 11, opacity: 0.4, letterSpacing: '0.08em' }}>
            Total: 9–16 hours per week recovered across a typical auto shop.
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '72px 32px', background: 'var(--ink)', color: 'var(--paper)', borderBottom: '1px solid rgba(244,241,234,0.1)' }}>
        <div className="site-rail mx-auto">
          ...
          <h2 style={{ fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.1, marginBottom: 40, maxWidth: 600 }}>
            Every shop model. One AI engine.
          </h2>
      ...
      <section style={{ padding: '48px 32px', borderBottom: '1px solid var(--ink)', background: 'rgba(20,20,19,0.03)' }}>
        <div className="site-rail mx-auto" style={{ display: 'flex', alignItems: 'center', gap: 32, flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', alignItems: 'center' }}>
            {['Mitchell1', 'NAPA TRACS', 'Tekmetric', 'Shop-Ware', 'Autoflow', 'QuickBooks', 'Stripe', 'Google Reviews', 'Yelp'].map(tool => (
      ...
      <section style={{ padding: '80px 32px', borderBottom: '1px solid var(--ink)' }}>
        <div className="site-rail mx-auto">
          ...
          {/* TODO: replace with real auto shop client testimonials */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, border: '1px solid var(--ink)' }} className="fitness-testimonial-grid">
            {[
              {
                stat: '14 hrs/wk recovered',
                quote: 'No-shows used to cost us 8–10 hours a week in wasted bay time. The reminder automation cut them by 55%. We\'re booking the same number of cars with zero wasted slots.',
                name: 'Marcus T.',
                biz: 'Auto Repair Shop — Austin, TX',
              },
              {
                stat: '+31% declined service revenue',
                quote: 'We had no idea how much money we were leaving in declined repairs. The automated 30-day follow-up brought back 31% of that work. It\'s like finding revenue that was already ours.',
                name: 'Priya S.',
                biz: 'Tire Center — Chicago, IL',
              },
              {
                stat: '5× more reviews',
                quote: 'We went from 28 reviews to 141 in five months. The post-pickup text goes out two hours after they leave, when they\'re still thinking about the service. It works every time.',
                name: 'Jordan R.',
                biz: 'Quick Lube — Miami, FL',
              },
        ...
        <div className="site-rail mx-auto">
          <div style={{ maxWidth: 640, marginBottom: 48 }}>
            ...
            <p style={{ fontSize: 16, opacity: 0.55, lineHeight: 1.6, margin: 0 }}>
              Our AI maps your shop&apos;s operation, identifies every automation opportunity, and
              delivers a custom Evolution Report with a 90-day build roadmap — specific to your
              shop type, tools, and car count.
            </p>
          </div>
          ...
          <div style={{
            ...
            <ChatEngine defaultTier="core" defaultIndustry="Automotive / Auto Repair" />
          </div>

  ...
  const tiers = [
    {
      ...
      name: 'Agent One',
      label: '1 workflow',
      who: 'Small business that needs one clear operating layer',
      price: showMonthly ? '$499' : '$4,990',
      period: showMonthly ? '/month' : '/year',
      saving: showMonthly ? null : 'Save $998 vs monthly',
      highlight: false,
      features: [
        'Private client agent page',
        'Weekly recommendations',
        '1 integration / automation',
        'SCO add-on available',
        '$2,000 website add-on',
      ],
    },
    {
      id: 'core',
      ...
      name: 'Agent Three',
      label: '3 workflows',
      who: 'Growing business with multiple repeated workflows',
      price: showMonthly ? '$999' : '$9,990',
      period: showMonthly ? '/month' : '/year',
      saving: showMonthly ? null : 'Save $1,998 vs monthly',
      highlight: true,
      features: [
        'Private client agent page',
        'Weekly recommendations',
    ...
    },
    {
      ...
      code: 'T-03',
      name: 'Agent Five',
      label: '5 workflows + growth',
      who: 'Established business using eevolvv as its AI ops layer',
      price: showMonthly ? '$1,999' : '$19,990',
      period: showMonthly ? '/month' : '/year',
      saving: showMonthly ? null : 'Save $3,998 vs monthly',
      highlight: false,
      features: [
        'Private client agent page',
        'Weekly recommendations',
        'Up to 5 integrations / automations',
        'Ads, SEO, and SCO included',
